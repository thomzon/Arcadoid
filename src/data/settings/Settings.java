...
{	
	...
	public enum PropertyId {
		...
		REPOSITORY_NES_ROMS_PATH("repo_nes_roms_path", Messages.get("field.nesDataPath")),
		...
		NES_ROMS_FOLDER_PATH("nes_roms_folder_path", Messages.get("field.nesRomsFolderPath")),
		...
		ROCKNESX_PATH("rocknesx_path", Messages.get("field.rocknesxExecutablePath")),
