...
public interface KeyboardDelegate
{
	 ...
	 */
	default public void combinationPressed(String combinationKey) {}
	/**
	 ...
	 */
	default public void keyReleased(int keyCode, String keyName) {}
	/**
	 * Called by the KeyboardListener when a key has been pressed
	 * @param keyCode Code of the pressed key
	 * @param keyName Name of the pressed key
	 */
	default public void keyPressed(int keyCode, String keyName) {}
